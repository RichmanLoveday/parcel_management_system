<?php
    ...
    include '../includes/css_files.php'; 
      ...
      if(isset($_POST['search'])) {
          include '../process/incoming_package_process.php';

      } elseif(isset($_POST['arrived'])) {
          include '../process/arrive_process.php';
      } else {
          echo '';
      }
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Incoming Package</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                    <li class="breadcrumb-item active">Incoming Package</li>
                </ol>
                <!-- <div class="card mb-4">
                            <div class="card-body">
                                <p class="mb-0">
                ...
                <div class="container my-lg-5">
                    <form action="incoming_package.php" method="post">
                ...
                <?php if (isset($_SESSION['output'])) { 
                        ...
                        if(isset($_GET['id'])) {
                            ...
                            dpackage_registration.dpackage_id = dbooking.dpackage WHERE dbooking_id = '$booking_id'");
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="../process/arrive_process.php" method="post">
                            <div class="container">
                            ...
                            <button class="btn btn-primary " data-bs-toggle="modal" name="arrived"
                                data-bs-target="#myModal" style="">Arrived
                            </button>
                        </form>
                    </div>
                    ...
                    <?php if(isset($_SESSION['null1'])) {  ?>
                    <span class="text-danger"><?php echo $_SESSION['null1']?></span>
                    <?php } ?>
                    <span class="text-success">
                        <?php echo isset($_SESSION['arrived']) ? $_SESSION['arrived'] : '' ?>
                    </span>
                </div>
